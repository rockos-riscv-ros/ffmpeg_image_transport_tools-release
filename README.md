...
The packages in the `ffmpeg_image_transport_tools` repository were released into the `jazzy` distro by running `/home/z572/gits/rockos-ros/venv/bin/bloom-release -r jazzy ffmpeg_image_transport_tools --override-release-repository-push-url git@github.com:rockos-riscv-ros/ffmpeg_image_transport_tools-release.git` on `Fri, 21 Mar 2025 07:06:23 -0000`
...
- release repository: https://github.com/rockos-riscv-ros/ffmpeg_image_transport_tools-release.git
